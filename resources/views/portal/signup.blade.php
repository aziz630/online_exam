...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Login-->
			<div class="login login-3 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid">
						...
						<div class="login-form">
							...
							<form action="{{ route('save.signUp') }}" method="post" class="form" >
								...
								<div class="form-group">
									...
									<input class="form-control h-auto py-5 px-6 rounded-lg border-0" type="text" name="name" autocomplete="off" />
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control h-auto py-5 px-6 rounded-lg border-0" type="email" name="email" autocomplete="off" />
								</div>
								<div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Your Password</label>
									<input class="form-control h-auto py-5 px-6 rounded-lg border-0" type="password" name="password" autocomplete="off" />
								</div>
								<div class="form-group">
									<label class="font-size-h6 font-weight-bolder text-dark">Phone Number</label>
									<input class="form-control h-auto py-5 px-6 rounded-lg border-0" type="text" name="phone" autocomplete="off" />
								</div>
								<!--end::Form group-->
								<!--begin::Action-->
