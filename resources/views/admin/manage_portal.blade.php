...
<div class="card card-custom mb-7">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">
                {{ __("Portal") }} <small>Filteration enabled</small>
            </h3>
        </div>
            ...
            @foreach($portals as $key => $value)
                ...
                <td>{{$key+1}}</td>
                   ...
                   <td><label class="checkbox checkbox-outline checkbox-outline-2x checkbox-primary">
                    <input class="portal_status" data-id="<?php echo $value->id?>" <?php if($value->status == 1) { echo "checked"; } ?> type="checkbox" name="Checkboxes15"  />
                    <span></span></label></td>
                    <td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('add_portal') }}" method="post">
            @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="phone" required="required" placeholder="Enter Phone No"
            value="{{ old('phone') }}">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/editPortal" method="post" id="editForm">
            @csrf
            {{ method_field('PUT') }}
            <div class="form-group">
            <label for="recipient-name" class="col-form-label">Name:</label>
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Phone:</label>
            <input type="email" class="form-control" name="phone" id="phone" placeholder="Enter Phone No"
            >
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Delete Portal</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="/deletePortal" method="post" id="deleteForm">
            @csrf
            {{ method_field('DELETE') }}
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        table.on('click','.edit', function(){
            ...
            $('#editForm').attr('action', '/editPortal/'+data[0]);
         ...
         table.on('click','.delete', function(){
            ...
            $('#deleteForm').attr('action', '/deletePortal/'+data[0]);
